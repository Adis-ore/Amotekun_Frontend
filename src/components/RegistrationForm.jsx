    ...
    return (
      <div className="px-8 py-10 text-center">
        ...
        {pdfBlobUrl && (
          <button
            type="button"
            className="mt-5 px-8 py-3 bg-brand text-white border-none rounded text-sm font-bold cursor-pointer tracking-[0.04em] uppercase hover:bg-brand-dark transition-colors duration-200 shadow-[0_3px_10px_rgba(123,29,51,0.3)]"
            onClick={() => {
    ...
    <>
      <form onSubmit={handleSubmit} noValidate>
        ...
        <FormSection title="2. Security Background">
          ...
          {formData.hasSecurityExp === 'Yes' && (
            <div className="bg-[#FBF0F2] border border-[#E8B8C2] rounded-md px-5 py-5 mt-1 flex flex-col gap-4">
        ...
        <FormSection title="5. Declaration">
          <label
            className={`flex gap-3.5 items-start cursor-pointer p-4 bg-[#FBF0F2] border rounded-lg transition-colors ${
              errors.declaration ? 'border-danger' : 'border-[#E8B8C2]'
            }`}
        ...
        {showConfirm && (
          <div className="fixed inset-0 bg-black/55 flex items-center justify-center z-[1000] p-4 md:p-5">
            <div className="bg-white rounded-xl px-6 md:px-8 py-8 w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex flex-col border border-[#E8B8C2] rounded-lg overflow-hidden mb-5">
              ...
              <div className="flex gap-3 justify-end flex-wrap">
                ...
                <button
                  type="button"
                  className="px-5 py-2.5 bg-brand text-white border-none rounded text-sm font-bold cursor-pointer tracking-[0.03em] hover:bg-brand-dark transition-colors shadow-[0_3px_10px_rgba(123,29,51,0.3)] min-h-[44px]"
      ...
      {isSubmitting && (
        <div
          ...
          style={{ backgroundColor: 'rgba(77,14,30,0.93)' }}
        >
...
function ReviewRow({ label, value }) {
  return (
    <div className="flex justify-between items-start gap-3 px-3.5 py-2.5 bg-white border-b border-[#E8B8C2] last:border-b-0">
...
function FormSection({ title, children }) {
  return (
    <div className="border-b border-gray-200">
      <div className="bg-[#FBF0F2] border-b border-[#E8B8C2] px-6 md:px-8 py-3.5">
